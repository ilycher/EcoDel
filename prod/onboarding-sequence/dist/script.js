...
function App() {
  ...
  return (
    ...
    React.createElement("div", _extends({ className: "container" }, bind()),
    ...
    React.createElement("li", { className: "titleItem" }, "Outstanding"),
    React.createElement("li", { className: "titleItem" }, "Extraordinary"),
    React.createElement("li", { className: "titleItem" }, "Superb"))),


    React.createElement("div", { className: "title2" }, "REAL ESTATE"),
    React.createElement("div", { className: "title3" }, "AGENTS")),

    React.createElement("svg", { className: "blob", width: "256", height: "464", viewBox: "0 0 256 464" },
    ...
    React.createElement(P1, null)),

    React.createElement(animated.div, {
      className: "person person2",
      style: { transform: x.to(x => `rotate(${x / 10 + 20}deg)`) } },

    React.createElement(P2, null)),

    React.createElement(animated.div, {
      className: "person person3",
      style: { transform: x.to(x => `rotate(${x / 10 + 40}deg)`) } },

    React.createElement(P3, null)),

    React.createElement("div", { className: "text" }, "Lorem ipsum dolor sit amet consectetur adipisicing elit. Laudantium facere"),



    React.createElement("div", { className: "navDots" },
    React.createElement(animated.div, {
      className: "navDot",
      style: {
